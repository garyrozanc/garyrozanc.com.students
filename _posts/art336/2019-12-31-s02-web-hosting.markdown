...
Finally, you can also change your default password. The password sent to you in your welcome email is randomly generated and I don’t have access to it. Even though I don’t have access to it, it’s pretty hard to remember unless you are using a password manager like 1Password or LastPass, so you may want to change it to something you will easily remember.
